  ...
  constructor() {
    this.menus = [
      ...
      { name: 'About-Dev', route: '/about/developer' },
      {
        ...
        items: [
          ...
          { empty: true },
          {
            ...
            route: '/examples/countries/countrybyname',
          },
          {
            name: 'Countries by Capital',
            route: '/examples/countries/countrybycapital',
          },
          { empty: true },
      ...
      },
      {
        name: 'Templates',
        items: [
          { name: 'Pipes - Built-In', route: '/templates/pipes/built-in' },
          { name: 'Pipes - Custom', route: '/templates/pipes/custom' },
        ],
      },
      {
        name: 'Directives',
        items: [
          {
            ...
            route: '/directives/attribute-directives',
          },
          {
            name: 'Structural-Directives',
            route: '/directives/structural-directives',
          },
        ],
      },
      { name: 'Routes', items: [{ name: 'Main', route: '/routes/main' }] },
      {
        ...
        items: [
          ...
          { empty: true },
          { name: 'Template - Basic', route: '/frms/template/basic' },
          { name: 'Template - Dynamic', route: '/frms/template/dynamic' },
          {
            name: 'Template - Validations',
            route: '/frms/template/validations',
          },
          { empty: true },
          { name: 'Reactive - Basic', route: '/frms/reactive/basic' },
          { name: 'Reactive - Dynamic', route: '/frms/reactive/dynamic' },
          {
            name: 'Reactive - Validations',
            route: '/frms/reactive/validations',
          },
        ],
      },
      ...
      },
      {
        name: 'Tools',
        items: [
          { name: 'Commands', route: '/tools/commands' },
          { name: 'Environments', route: '/tools/environments' },
        ],
      },
    ];
  }
